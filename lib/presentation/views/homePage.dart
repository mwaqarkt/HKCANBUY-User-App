...
import 'package:user_app/application/productList.dart';
...
import 'package:user_app/infrastructure/services/bannerServices.dart';
import 'package:user_app/infrastructure/services/productServices.dart';
import 'package:user_app/presentation/elements/appDrawer.dart';
...
import 'package:user_app/presentation/elements/searchField.dart';
import 'package:user_app/presentation/elements/searchFieldBackArrow.dart';
    ...
    return StreamProvider.value(
      ...
      builder: (context, child) {
        if (productsProvider.getProducts
            .isEmpty) if (context.watch<List<CompleteProductModel>>() != null)
          productsProvider
