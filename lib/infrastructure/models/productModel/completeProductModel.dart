import 'package:user_app/infrastructure/models/productModel/productBulkModel.dart';
import 'package:user_app/infrastructure/models/productModel/productDiscountModel.dart';
import 'package:user_app/infrastructure/models/productModel/productFeatureModel.dart';
import 'package:user_app/infrastructure/models/productModel/productGeneralDetailsModel.dart';
...
//
  ...
  CompleteProductModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['sizePriceQuantityModel'] != null) {
      sizePriceQuantityModel = new List<SizePriceQuantityJsonModel>();
